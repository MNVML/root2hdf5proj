...
{
    // values computed with ANNMINERvA plane_codes.py
    if (raw_code == 1) return 9;
    if (raw_code == 2) return 18;
    if (raw_code == 3) return 27;
    if (raw_code == 4) return 44;
    if (raw_code == 5) return 49;
    if (raw_code == 1040) return 59;
    if (raw_code == 3120) return 189;
    if (raw_code == 520) return 28;
    if (raw_code == 2728) return 164;
    if (raw_code == 3376) return 199;
    if (raw_code == 528) return 29;
    if (raw_code == 2472) return 148;
    if (raw_code == 2888) return 174;
    if (raw_code == 1552) return 91;
    if (raw_code == 3632) return 207;
    if (raw_code == 1160) return 66;
    if (raw_code == 1808) return 107;
    if (raw_code == 1456) return 85;
    if (raw_code == 1416) return 82;
    if (raw_code == 2064) return 123;
    if (raw_code == 40) return 3;
    if (raw_code == 1672) return 98;
    if (raw_code == 2320) return 139;
    if (raw_code == 48) return 4;
    if (raw_code == 8) return 1;
    if (raw_code == 1928) return 114;
    if (raw_code == 2576) return 155;
    if (raw_code == 1896) return 112;
    if (raw_code == 104) return 7;
    if (raw_code == 2184) return 130;
    if (raw_code == 752) return 43;
    if (raw_code == 2832) return 171;
    if (raw_code == 360) return 21;
    if (raw_code == 2440) return 146;
    if (raw_code == 3088) return 187;
    if (raw_code == 1096) return 62;
    if (raw_code == 2696) return 162;
    if (raw_code == 2128) return 127;
    if (raw_code == 3344) return 198;
    if (raw_code == 1104) return 63;
    if (raw_code == 2952) return 178;
    if (raw_code == 1520) return 89;
    if (raw_code == 3600) return 206;
    if (raw_code == 1776) return 105;
    if (raw_code == 272) return 17;
    if (raw_code == 2984) return 180;
    if (raw_code == 2032) return 121;
    if (raw_code == 616) return 34;
    if (raw_code == 1640) return 96;
    if (raw_code == 2288) return 137;
    if (raw_code == 112) return 8;
    if (raw_code == 1128) return 64;
    if (raw_code == 2384) return 143;
    if (raw_code == 2544) return 153;
    if (raw_code == 3216) return 194;
    if (raw_code == 2152) return 128;
    if (raw_code == 720) return 41;
    if (raw_code == 2800) return 169;
    if (raw_code == 328) return 19;
    if (raw_code == 2408) return 144;
    if (raw_code == 1904) return 113;
    if (raw_code == 3056) return 185;
    if (raw_code == 648) return 36;
    if (raw_code == 2664) return 160;
    if (raw_code == 3312) return 197;
    if (raw_code == 1168) return 67;
    if (raw_code == 2920) return 176;
    if (raw_code == 1488) return 87;
    if (raw_code == 3568) return 205;
    if (raw_code == 3176) return 192;
    if (raw_code == 1744) return 103;
    if (raw_code == 3824) return 213;
    if (raw_code == 624) return 35;
    if (raw_code == 2000) return 119;
    if (raw_code == 168) return 10;
    if (raw_code == 584) return 32;
    if (raw_code == 2256) return 135;
    if (raw_code == 176) return 11;
    if (raw_code == 712) return 40;
    if (raw_code == 432) return 26;
    if (raw_code == 2512) return 151;
    if (raw_code == 2120) return 126;
    if (raw_code == 688) return 39;
    if (raw_code == 2768) return 167;
    if (raw_code == 2376) return 142;
    if (raw_code == 3024) return 183;
    if (raw_code == 1224) return 70;
    if (raw_code == 1200) return 69;
    if (raw_code == 3280) return 196;
    if (raw_code == 1232) return 71;
    if (raw_code == 840) return 47;
    if (raw_code == 3536) return 204;
    if (raw_code == 1064) return 60;
    if (raw_code == 3144) return 190;
    if (raw_code == 1712) return 101;
    if (raw_code == 3792) return 212;
    if (raw_code == 1320) return 76;
    if (raw_code == 208) return 13;
    if (raw_code == 1968) return 117;
    if (raw_code == 1576) return 92;
    if (raw_code == 232) return 14;
    if (raw_code == 2224) return 133;
    if (raw_code == 3152) return 191;
    if (raw_code == 1832) return 108;
    if (raw_code == 1264) return 73;
    if (raw_code == 552) return 30;
    if (raw_code == 400) return 24;
    if (raw_code == 2480) return 149;
    if (raw_code == 2088) return 124;
    if (raw_code == 656) return 37;
    if (raw_code == 2736) return 165;
    if (raw_code == 264) return 16;
    if (raw_code == 2344) return 140;
    if (raw_code == 2992) return 181;
    if (raw_code == 2600) return 156;
    if (raw_code == 1288) return 74;
    if (raw_code == 3248) return 195;
    if (raw_code == 2856) return 172;
    if (raw_code == 1296) return 75;
    if (raw_code == 3504) return 203;
    if (raw_code == 3408) return 200;
    if (raw_code == 1032) return 58;
    if (raw_code == 3112) return 188;
    if (raw_code == 1680) return 99;
    if (raw_code == 3760) return 211;
    if (raw_code == 560) return 31;
    if (raw_code == 1936) return 115;
    if (raw_code == 1544) return 90;
    if (raw_code == 808) return 45;
    if (raw_code == 2192) return 131;
    if (raw_code == 1800) return 106;
    if (raw_code == 1328) return 77;
    if (raw_code == 904) return 50;
    if (raw_code == 2448) return 147;
    if (raw_code == 2056) return 122;
    if (raw_code == 2416) return 145;
    if (raw_code == 2704) return 163;
    if (raw_code == 2312) return 138;
    if (raw_code == 2960) return 179;
    if (raw_code == 2568) return 154;
    if (raw_code == 1352) return 78;
    if (raw_code == 1136) return 65;
    if (raw_code == 1608) return 94;
    if (raw_code == 2824) return 170;
    if (raw_code == 848) return 48;
    if (raw_code == 3472) return 202;
    if (raw_code == 3080) return 186;
    if (raw_code == 1648) return 97;
    if (raw_code == 3728) return 210;
    if (raw_code == 1256) return 72;
    if (raw_code == 1424) return 83;
    if (raw_code == 1512) return 88;
    if (raw_code == 1384) return 80;
    if (raw_code == 2160) return 129;
    if (raw_code == 1768) return 104;
    if (raw_code == 1392) return 81;
    if (raw_code == 744) return 42;
    if (raw_code == 1864) return 110;
    if (raw_code == 2024) return 120;
    if (raw_code == 592) return 33;
    if (raw_code == 2672) return 161;
    if (raw_code == 200) return 12;
    if (raw_code == 2280) return 136;
    if (raw_code == 2928) return 177;
    if (raw_code == 2536) return 152;
    if (raw_code == 392) return 23;
    if (raw_code == 3184) return 193;
    if (raw_code == 2792) return 168;
    if (raw_code == 912) return 51;
    if (raw_code == 3440) return 201;
    if (raw_code == 3048) return 184;
    if (raw_code == 1616) return 95;
    if (raw_code == 3696) return 209;
    if (raw_code == 1872) return 111;
    if (raw_code == 240) return 15;
    if (raw_code == 1480) return 86;
    if (raw_code == 424) return 25;
    if (raw_code == 1736) return 102;
    if (raw_code == 944) return 53;
    if (raw_code == 72) return 5;
    if (raw_code == 1992) return 118;
    if (raw_code == 2640) return 159;
    if (raw_code == 2248) return 134;
    if (raw_code == 816) return 46;
    if (raw_code == 2896) return 175;
    if (raw_code == 2504) return 150;
    if (raw_code == 1072) return 61;
    if (raw_code == 968) return 54;
    if (raw_code == 2760) return 166;
    if (raw_code == 336) return 20;
    if (raw_code == 976) return 55;
    if (raw_code == 1360) return 79;
    if (raw_code == 936) return 52;
    if (raw_code == 3016) return 182;
    if (raw_code == 1584) return 93;
    if (raw_code == 3664) return 208;
    if (raw_code == 1192) return 68;
    if (raw_code == 1840) return 109;
    if (raw_code == 80) return 6;
    if (raw_code == 1448) return 84;
    if (raw_code == 16) return 2;
    if (raw_code == 2096) return 125;
    if (raw_code == 1000) return 56;
    if (raw_code == 1704) return 100;
    if (raw_code == 2352) return 141;
    if (raw_code == 1008) return 57;
    if (raw_code == 680) return 38;
    if (raw_code == 1960) return 116;
    if (raw_code == 368) return 22;
    if (raw_code == 2608) return 157;
    if (raw_code == 2632) return 158;
    if (raw_code == 2216) return 132;
    if (raw_code == -1) return 0;
    if (raw_code == 2864) return 173;
    return -1;
}
